...
CREATE TABLE ORDERS (
    ...
    -- 결제 방식 : 카드 CARD, 가상 계좌 VBANK, 무통장 입금 TRANS, 휴대폰 소액결제 PHONE, 카카오페이 KAKAO
                        ...
                        CONSTRAINT FK_ORDERS_MEMBER FOREIGN KEY (M_ID) REFERENCES MEMBER (MEMBER_ID) ON DELETE CASCADE,
						CONSTRAINT FK_ORDERS_COMPANY FOREIGN KEY (C_ID) REFERENCES COMPANY (COMPANY_ID) ON DELETE CASCADE,
...
CREATE TABLE INTRO (
                        ...
                        CONSTRAINT FK_INTRO_COMPANY FOREIGN KEY (C_ID) REFERENCES COMPANY(COMPANY_ID) ON DELETE CASCADE
);